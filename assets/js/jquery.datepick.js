...
monthsOffset: function(date) { // Always start on the quarter
  ...
  alert('Selected ' + dates);
        ...
        /** Localisations for the plugin.
        	...
        	@property {string} [dateFormat='dd/mm/yyyy'] See options on {@linkcode module:Datepick~formatDate|formatDate}.
...
$.datepick.newDate(2014, 12, 25) */
        ...
        _attachments: function(elem, inst) {
            ...
            inst.trigger = (!trigger ? $([]) :
                $(trigger).clone().removeAttr('id').addClass(this._triggerClass)[inst.options.isRTL ? 'insertBefore' : 'insertAfter'](elem).click(function() {
